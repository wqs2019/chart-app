...
export type CheckinModerationStatus = 'normal' | 'violating' | 'reviewing';
...
export interface CheckinContentEntry {
  ...
  moderation_status?: CheckinModerationStatus;
  moderation_updated_at?: Date | string;
  created_at?: Date | string;
  updated_at?: Date | string;
}
